...
<header class="eh">
	<div class="topbar">
		<div class="wrap topbar__row">
			...
			if (is_front_page()) : ?><h1 class="topbar__place" style="font-size:13px;margin:0;font-weight:400;line-height:inherit"><?php else : ?><span class="topbar__place"><?php endif; ?><b><?php echo esc_html($topbar_title); ?></b><?php if ($topbar_desc) : ?><span class="topbar__desc"> · <?php echo esc_html($topbar_desc); ?></span><?php endif; ?><?php if (is_front_page()) : ?></h1><?php else : ?></span><?php endif; ?>
			</div>
