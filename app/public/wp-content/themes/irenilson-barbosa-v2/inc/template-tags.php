...
function ib_render_social( $class = 'soc' ) {
	$icons = [
		'facebook' => '<circle cx="12" cy="12" r="10" fill="none" stroke="currentColor"/><path d="M14 10V8a2 2 0 0 1 2-2h1V4h-3a4 4 0 0 0-4 4v2H8v4h2v8h4v-8h2l.5-4H14z" fill="none" stroke="currentColor"/>',
		'instagram' => '<rect x="2" y="2" width="20" height="20" rx="5" fill="none" stroke="currentColor"/><circle cx="12" cy="12" r="5" fill="none" stroke="currentColor"/><circle cx="17" cy="7" r="1.5" fill="none" stroke="currentColor"/>',
		'youtube' => '<rect x="2" y="4" width="20" height="16" rx="4" fill="none" stroke="currentColor"/><polygon points="10 8 10 16 17 12 10 8" fill="none" stroke="currentColor"/>',
	];
