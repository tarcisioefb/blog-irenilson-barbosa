...
<div class="wrap single-wrap" id="main">
	...
	<div class="ib-book-detail-grid" style="display:grid;grid-template-columns:minmax(0,300px) minmax(0,1fr);gap:clamp(var(--space-6),4vw,var(--space-10));align-items:start;margin-bottom:var(--space-10)">
