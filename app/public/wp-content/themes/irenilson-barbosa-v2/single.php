		...
		<div class="article-layout">
			<article <?php post_class( 'article' ); ?>>
				...
				<?php if ( has_post_thumbnail() ) : ?>
					<figure class="article__hero"><?php the_post_thumbnail( 'full', array( 'alt' => esc_attr( get_the_title() ) ) ); if ( get_the_post_thumbnail_caption() ) : ?><figcaption><?php the_post_thumbnail_caption(); ?></figcaption><?php endif; ?></figure>
				<?php endif; ?>
